                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                @if (Auth::guard('admin')->user()->quyen == 1)
                                    <a class="dropdown-item" href="{{ route('staff.change.info', ['id' => Auth::guard('admin')->user()->id_qtv]) }}">
                                        <i class="fas fa-pencil-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                        Cập nhật thông tin
                                    </a>
                                    <a class="dropdown-item" href="{{ route('staff.change.pass', ['id' => Auth::guard('admin')->user()->id_qtv]) }}">
                                        <i class="fas fa-pencil-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                        Đổi mật khẩu
                                    </a>
                                @endif
