...
Route::namespace('Client')->prefix('/')->group(function () {
    Route::namespace('Auth')->prefix('auth')->group(function () {
        ...
        Route::get('/change-pass', 'AuthController@showChangePass')->name('auth.change.password');
        Route::post('/change-pass', 'AuthController@updatePass')->name('auth.updatepass');
    });
   ...
   //
   Route::post('update-item/{id}', 'ProductController@updateItem')->name('increase.item');
   //
...
Route::namespace('Admin')->prefix('ad')->group(function () {
    ...
    Route::group(['middleware' => 'check.admin.login'], function () {
        ...
        Route::get('filter-order', 'DashboardController@fillterMonney')->name('filter.money');
        ...
        Route::group(['prefix' => 'order'], function () {
            Route::get('filter-order2', 'OrderController@fillterOrder2')->name('order.list2');
