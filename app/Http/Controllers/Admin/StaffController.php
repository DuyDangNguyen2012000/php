...
class StaffController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $staff->matkhau = $staff->matkhau == $request->password ? $staff->matkhau : bcrypt($request->password);
        $staff->save();
    ...
    public function changePass(Request $request, $id)
    {
        ...
        if (Hash::check($request->oldpassword, $staff->matkhau)) {
            if($request->input('password') === $request->input('repassword')){
                Admin::where('email', $staff->email)->update(['matkhau' => bcrypt($request->input('password'))]);
