...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('client/css/admin.css') }}" type="text/css">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            @else
                            <div class="header__top__right__auth">
                                Xin chào, {{ Auth::guard('admin')->user()->hoten }}
                            </div>
                            <div class="header__top__right__auth">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        if (strtotime(date('Y-m-d')) < strtotime($row['item']['thoigianbatdau']) || strtotime(date('Y-m-d'))> strtotime($row['item']['thoigianketthuc']))
                            ...
                            @endphp
                            <div class="header__cart__price">Tổng: <span id="price_cart">{{ Session::has('cart') ? number_format($total,-3,',',',') : 0 }} ₫</span></div>
                    </div>
                </div>
            </div>
